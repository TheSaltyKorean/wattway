  ...
  },
  {
    ...
    schema: {
      ...
      step: [
        ...
        { "@type": "HowToStep", name: "Score candidates on total cost", text: "Rank reachable stations on effective price per kWh plus penalties for detour distance and for stalls below 150 kW, and take the best." },
